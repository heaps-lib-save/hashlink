...
class Window {
	...
	**/
	...
	static function pacerInit( targetFps : Float );
	static function pacerMark();
	static function pacerWait();
	static function pacerInterval() : Float;
